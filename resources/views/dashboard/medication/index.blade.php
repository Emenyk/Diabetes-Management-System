...
<div class="col-lg-12 d-md-flex">
    ...
    <div class="col-lg-6">
      <div class="text-lg-end">
        <a href="{{ route('reminder.create') }}" class="ud-btn btn-dark default-box-shadow2">Create Reminder<i class="fal fa-arrow-right-long"></i></a>
      </div>
    </div>
  </div>
              ...
              <tr>
                <th class="ps-0" scope="row">
                  <div class="freelancer-style1 p-0 mb-0 box-shadow-none">
                    <div class="d-lg-flex align-items-lg-center">
                      <div class="thumb w60 position-relative rounded-circle mb15-md">
                        <img class="rounded-circle mx-auto" src="{{ asset('images/team/client-2.png') }}" alt="">
                      </div>
                      <div class="details ml15 ml0-md mb15-md">
              ...
              <tr>
                <th class="ps-0" scope="row">
                  <div class="freelancer-style1 p-0 mb-0 box-shadow-none">
                    <div class="d-lg-flex align-items-lg-center">
                      <div class="thumb w60 position-relative rounded-circle mb15-md">
                        <img class="rounded-circle mx-auto" src="{{ asset('images/team/client-3.png') }}" alt="">
                      </div>
                      <div class="details ml15 ml0-md mb15-md">
              ...
              <tr>
                <th class="ps-0" scope="row">
                  <div class="freelancer-style1 p-0 mb-0 box-shadow-none">
                    <div class="d-lg-flex align-items-lg-center">
                      <div class="thumb w60 position-relative rounded-circle mb15-md">
                        <img class="rounded-circle mx-auto" src="{{ asset('images/team/client-4.png') }}" alt="">
                      </div>
                      <div class="details ml15 ml0-md mb15-md">
              ...
              <tr>
                <th class="ps-0" scope="row">
                  <div class="freelancer-style1 p-0 mb-0 box-shadow-none">
                    <div class="d-lg-flex align-items-lg-center">
                      <div class="thumb w60 position-relative rounded-circle mb15-md">
                        <img class="rounded-circle mx-auto" src="{{ asset('images/team/client-5.png') }}" alt="">
                      </div>
                      <div class="details ml15 ml0-md mb15-md">
              ...
              <tr>
                <th class="ps-0" scope="row">
                  <div class="freelancer-style1 p-0 mb-0 box-shadow-none">
                    <div class="d-lg-flex align-items-lg-center">
                      <div class="thumb w60 position-relative rounded-circle mb15-md">
                        <img class="rounded-circle mx-auto" src="{{ asset('images/team/client-6.png') }}" alt="">
                      </div>
                      <div class="details ml15 ml0-md mb15-md">
