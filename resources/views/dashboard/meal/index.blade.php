...
<div class="col-lg-12 d-md-flex">
    <div class="dashboard_title_area">
      <h2>Meal Plan</h2>
      <p class="text">Your nutrition can aslo be checked to improve health.</p>
    </div>
    <div class="col-lg-6">
      <div class="text-lg-end">
        <a href="{{ route('meal.plan') }}" class="ud-btn btn-dark default-box-shadow2">All Plan<i class="fal fa-arrow-right-long"></i></a>
      </div>
    </div>
    <div class="col-lg-3">
      <div class="text-lg-end">
        <a href="{{ route('meal.create') }}" class="ud-btn btn-dark default-box-shadow2">New Plan<i class="fal fa-arrow-right-long"></i></a>
      </div>
    </div>
  </div>
        ...
        <div class="navtab-style1">
          <nav>
            <div class="nav nav-tabs mb30" id="nav-tab2" role="tablist">
              <button class="nav-link active fw500 ps-0" id="nav-item1-tab" data-bs-toggle="tab" data-bs-target="#nav-item1" type="button" role="tab" aria-controls="nav-item1" aria-selected="true">Meals</button>
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="col-sm-6 col-xl-3">
                    ...
                    <div class="list-thumb">
                        <img class="w-100" src="{{ asset('images/meal/meal-1.jpg') }}" alt="">
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="listing-style1">
                    <div class="list-thumb">
                        <img class="w-100" src="{{ asset('images/meal/meal-2.jpg') }}" alt="">
                        <a href="#" class="tag-del" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Delete Item" aria-label="Delete Item"><span class="flaticon-delete"></span></a>
                    </div>
                    <div class="list-content">
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="listing-style1">
                    <div class="list-thumb">
                        <img class="w-100" src="images/meal/meal-1.jpg" alt="">
                        <a href="#" class="tag-del" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Delete Item" aria-label="Delete Item"><span class="flaticon-delete"></span></a>
                    </div>
                    <div class="list-content">
                        <p class="list-text body-color fz14 mb-1">Diabetes Mellitus</p>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="listing-style1">
                    <div class="list-thumb">
                        <img class="w-100" src="images/meal/meal-2.jpg" alt="">
                        <a href="#" class="tag-del" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Delete Item" aria-label="Delete Item"><span class="flaticon-delete"></span></a>
                    </div>
                    <div class="list-content">
                        <p class="list-text body-color fz14 mb-1">Symptoms and early Signs</p>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="listing-style1">
                    <div class="list-thumb">
                        <img class="w-100" src="{{ asset('images/meal/meal-3.jpg') }}" alt="">
                        <a href="#" class="tag-del" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Delete Item" aria-label="Delete Item"><span class="flaticon-delete"></span></a>
                    </div>
                    <div class="list-content">
                        <p class="list-text body-color fz14 mb-1">Blood sugar level</p>
